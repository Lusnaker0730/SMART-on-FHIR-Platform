...
describe('Creatinine Clearance (CrCl) Calculator', () => {
    ...
    test('should calculate CrCl for male patient', () => {
        ...
        const creatinineInput = container.querySelector('#crcl-creatinine');
        const maleRadio = container.querySelector('input[name="crcl-sex"][value="male"]');
    ...
    test('should calculate CrCl for female patient (0.85 factor)', () => {
        ...
        const weightInput = container.querySelector('#crcl-weight');
        const creatinineInput = container.querySelector('#crcl-creatinine');
        const femaleRadio = container.querySelector('input[name="crcl-sex"][value="female"]');
