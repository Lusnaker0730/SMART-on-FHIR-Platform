 ...
 */
import type { AlertSeverity, BaseCalculatorConfig, BaseRiskLevel, FieldDataRequirement, UnitToggleConfig } from './calculator-base.js';
/** 藥物選項 */
...
export interface DynamicListCalculatorConfig extends BaseCalculatorConfig {
    ...
    additionalInfo?: string;
    /** 自訂結果渲染函數 */
    customResultRenderer?: (total: number, items: Array<{
        option: string;
        value: number;
    }>) => string;
}
...
/** 混合輸入項類型 */
export type MixedInputItemConfig = MixedNumberInputConfig | MixedRadioGroupConfig | MixedSelectConfig;
/** 混合輸入區塊配置 */
...
//# sourceMappingURL=calculator-specialized.d.ts.map